...
with open('C:/Users/sally/Desktop/2021-2/학사/Computer System/과제/팀플2/ComputerSystemProject2/Mariah Carey_1990_2010.txt', 'r') as f:
    lyrics= f.read()
...
with open('C:/Users/sally/Desktop/2021-2/학사/Computer System/과제/팀플2/ComputerSystemProject2/stopwords_english.txt', 'r') as f:
...
class cacheblock:
    ...
    def isnotfull(self):
        if len(self.memoryblock)==8: return False
        else: return True
